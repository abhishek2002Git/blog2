      ...
      <div className="right-side-author">
        ...
        <div>
          ...
          <div className="author-texts flex">
            ...
            <a href="mailto:abishekashukla@gmail.com">
              <p className="text-[#E53935] underline ml-1">
                abishekashukla@gmail.com
              </p>
            </a>
          </div>
          ...
          <div className="author-texts flex">
            ...
            <a href="https://twitter.com/messages/compose?recipient_id=abishekashukla">
              <p className="text-[#E53935] underline ml-1">@abishekAshukla</p>
            </a>
          </div>
        </div>
        <div className="social-links">
          <div className="social-link-author">
            <a href="https://twitter.com/abishekashukla">Twitter</a>
          </div>
          <div className="social-link-author">
            <a href="https://www.linkedin.com/in/abishekashukla">LinkedIn</a>
          </div>
          <div className="social-link-author">
            <a href="https://www.instagram.com/abishekashukla">Instagram</a>
          </div>
        </div>
      </div>
    </section>
